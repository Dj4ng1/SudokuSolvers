...
def locate_images(url):
    ...
    for section in sections:
        ...
        if img_tag and 'src' in img_tag.attrs:
            ...
            if section == 'kdaily':
                prefix = 'k_'
                download_image(first_image_url, UNSOLVED_FOLDER, f"{prefix}{k_count}.jpg")  #Save those in Unsolved
               # k_count += 1
            if section == 'gtdaily':
                prefix = 'gt_'
            ...
            if section == 'rdaily':
                prefix = 'r_'
                download_image(first_image_url, UNSOLVED_FOLDER, f"{prefix}{r_count}.jpg")  
                #r_count += 1        
        ...
        if anchor:
            ...
            if solution_link and 'href' in solution_link.attrs:
                ...
                if section == 'kdaily':
                    prefix = 'k_solved_'
                    download_image(solution_image_url, SOLVED_FOLDER, f"{prefix}{k_count}.jpg")  # And those in Solvedd
                    k_count += 1
                if section == 'gtdaily':
                    prefix = 'gt_solved_'
                ...
                if section == 'rdaily':
                    prefix = 'r_solved_'
                    download_image(solution_image_url, SOLVED_FOLDER, f"{prefix}{r_count}.jpg") 
                    r_count += 1
